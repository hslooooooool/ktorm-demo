...
interface IChatService {
    ...
    interface IMessage {
         ...
         * @param sessionId 会话ID
         * @param timeline 消息时序
         * @param next 请求消息时序以下的消息，反之以上
         * @param size 请求数量
         * @return 会话下的消息列表
         * */
        fun getMessageListBySessionIdAndTimeline(userId: Int, sessionId: Int, timeline: Int?, next: Boolean = true, size: Int = 20): List<ChatMessageInfoBo>
